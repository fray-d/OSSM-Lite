    ...
    auto operator()() const {
        ...
        // clang-format off
            ...
            *"idle"_s + done / drawHello = "homing"_s,
            ...
            "advancedPenetration.idle"_s + doublePress / setAdvancedChanged = "advancedPenetration.modifier"_s,
            ...
            "advancedPenetration.modifier"_s + doublePress / setAdvancedChanged = "advancedPenetration.idle"_s,
